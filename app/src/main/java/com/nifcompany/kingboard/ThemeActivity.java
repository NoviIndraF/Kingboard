    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.theme1_imageButton:
                editor.putInt(THEME_KEY, R.drawable.kb_bg_1).apply();
                break;
            case R.id.theme2_imageButton:
                editor.putInt(THEME_KEY, R.drawable.kb_bg_2).apply();
                break;
            case R.id.theme3_imageButton:
                editor.putInt(THEME_KEY, R.drawable.kb_bg_3).apply();
                break;
            case R.id.theme4_imageButton:
                editor.putInt(THEME_KEY, R.drawable.kb_bg_4).apply();
                break;
            case R.id.theme5_imageButton:
                editor.putInt(THEME_KEY, R.drawable.kb_bg_5).apply();
                break;
            case R.id.theme6_imageButton:
                editor.putInt(THEME_KEY, R.drawable.kb_bg_6).apply();
                break;
            case R.id.theme7_imageButton:
                editor.putInt(THEME_KEY, R.drawable.kb_bg_7).apply();
                break;
            case R.id.theme8_imageButton:
                editor.putInt(THEME_KEY, R.drawable.kb_bg_8).apply();
                break;
            case R.id.theme9_imageButton:
                editor.putInt(THEME_KEY, R.drawable.kb_bg_9).apply();
                break;
            case R.id.theme10_imageButton:
                editor.putInt(THEME_KEY, R.drawable.kb_bg_10).apply();
                break;
            default:
                break;
        }

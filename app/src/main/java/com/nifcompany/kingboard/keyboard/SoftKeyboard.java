...
import com.nifcompany.kingboard.MainActivity;
...
import static com.nifcompany.kingboard.ThemeActivity.THEME_KEY;
...
public class SoftKeyboard extends InputMethodService
    ...
    public View onCreateInputView() {
        ...
        mInputView = (LatinKeyboardView) getLayoutInflater().inflate(
                R.layout.input_1, null);
        mInputView.setBackgroundResource(sharedPreferences.getInt(THEME_KEY, R.drawable.kb_bg_8));
        ...
        for (int i = 0; i < keys.size() - 1; i++) {
            ...
            if (currentKey.codes[0] == -1) {
                ...
                if (mInputView.isShifted() || mCapsLock) {
                    currentKey.icon = getResources().getDrawable(R.drawable.ic_capslock_white);
                } else {
                    currentKey.icon = getResources().getDrawable(R.drawable.ic_capslock_border_white);
                }
                break;
            }
        }
    ...
    public void showEmoticons() {
        ...
        if (layoutInflater != null) {
            ...
            popupWindow = new EmojiconsPopup(popupView, this, true);

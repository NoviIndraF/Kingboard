...
import com.nifcompany.kingboard.adapter.SearchAdapter;
...
public class DictionaryActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabAdd = findViewById(R.id.FbAddText);
        ...
        fabAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DictionaryActivity.this, AddTextActivity.class);
